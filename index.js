fetch('./target/wasm32-unknown-unknown/release/rusty_checkers.wasm').then(response =>
  ...
  let result = instance.exports.move_piece(0, 5, 1, 4); // B
  console.log("First move result: " + result);
